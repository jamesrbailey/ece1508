...
plot_dir("results/r5")
plot_show(name="Irregular LDPC, r=5", x_label="Erasure Probability")

plot_dir("results/r6")
plot_show(name="Irregular LDPC, r=6", x_label="Erasure Probability")

plot_dir("results/r7")
plot_show(name="Irregular LDPC, r=7", x_label="Erasure Probability")

plot_file("results/avg_reg.data", label="Regular")
plot_file("results/r5_avg.data", label="r=5")
plot_file("results/r6_avg.data", label="r=6")
plot_file("results/r7_avg.data", label="r=7")
plt.ylim([10E-6,10E0])
